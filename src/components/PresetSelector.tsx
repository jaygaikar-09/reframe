  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <Tooltip block content="Search presets by platform or format name.">
          <input
            type="text"
      ...
      {recipe.preset === "custom" && (
        <div className="mt-2 flex items-center gap-4 rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4 shadow-sm animate-fade-in">
          <div className="flex-1">
            ...
            <Tooltip block content="Output width in pixels. Must be between 16 and 7680.">
              <input
                id="custom-width"
                type="number"
                autoComplete="off"
          ...
          <div className="flex-1">
            ...
            <Tooltip block content="Output height in pixels. Must be between 16 and 7680.">
              <input
                id="custom-height"
                type="number"
                autoComplete="off"
